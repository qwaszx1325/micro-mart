...
func (pu *PermissionUpdate) SetAllowed(b bool) *PermissionUpdate {
	pu.mutation.SetAllowed(b)
	return pu
}

// SetNillableAllowed sets the "allowed" field if the given value is not nil.
func (pu *PermissionUpdate) SetNillableAllowed(b *bool) *PermissionUpdate {
	if b != nil {
		pu.SetAllowed(*b)
	}
	return pu
...
func (pu *PermissionUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := pu.mutation.Allowed(); ok {
		_spec.SetField(permission.FieldAllowed, field.TypeBool, value)
	}
...
// SetAllowed sets the "allowed" field.
func (puo *PermissionUpdateOne) SetAllowed(b bool) *PermissionUpdateOne {
	puo.mutation.SetAllowed(b)
	return puo
}

// SetNillableAllowed sets the "allowed" field if the given value is not nil.
func (puo *PermissionUpdateOne) SetNillableAllowed(b *bool) *PermissionUpdateOne {
	if b != nil {
		puo.SetAllowed(*b)
	}
	return puo
...
func (puo *PermissionUpdateOne) sqlSave(ctx context.Context) (_node *Permission, err error) {
	...
	if value, ok := puo.mutation.Allowed(); ok {
		_spec.SetField(permission.FieldAllowed, field.TypeBool, value)
	}
